...
def get_feature_date_in_int(day: datetime.datetime) -> [int] :
    ...
    past_weekdays = [day - datetime.timedelta(x * 7) for x in range(3, num_past_weeks + 3)]
...
matrix = []
index = ["中类编码", "feature_1", "feature_2", "feature_3", "feature_4",
        "feature_5", "feature_6", "feature_7", "feature_8", "feature_9",
        "feature_10", "feature_11", "feature_12", "feature_13", "feature_14",
        "feature_15", "feature_16", "lable"]
...
out = out.transpose()
out.to_csv(DIR_PATH + 'processed_2.csv', sep=',', header=index, index=None)
